...
## Place:  Hasselt Belgium, 6th Channel Network Conference, 24/04/2017
##
...
##         cf.peeters@vumc.nl
## Date:   19/04/2017, Amsterdam, VUmc
##
###############################################################################
###############################################################################
...
setwd("C:/Users/cf.peeters/Desktop/Hasselt_2017/04. Exercises")
...
Colors2   <- c("lightblue", "orange", "yellow", "purple")
